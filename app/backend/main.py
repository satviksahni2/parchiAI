...
logger = logging.getLogger("DistriParse")

@asynccontextmanager
async def lifespan(app: FastAPI):
    # Startup
    logger.info("==================================================")
    logger.info("DistriParse WhatsApp Webhook Server Starting...")
    ...
    yield
    # Shutdown
    logger.info("DistriParse WhatsApp Webhook Server Shutting down...")

app = FastAPI(
    title="DistriParse B2B WhatsApp Webhook",
    description="Automated B2B order ingestion pipeline via WhatsApp Cloud API & Google Gemini 2.5 Flash",
    version="1.0.0",
    lifespan=lifespan
)
